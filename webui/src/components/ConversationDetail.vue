...
export default {
    ...
    watch: {
        // Watch for changes in the conversation prop
        conversation: {
            handler(newVal) {
                this.localConversation = { ...newVal };
            },
            immediate: true,
        },
    },
    ...
    computed: {
        conversationName() {
            return this.localConversation.name;
        },
    ...
    methods: {
        ...
        async addReaction(emoji) {
            ...
            try {
                await this.$axios.post(    // indented with tabs
        ...
        async updateGroupName() {
            ...
            try {
                ...
                // Update local copy instead of prop
                this.localConversation.name = this.newGroupName;

                // Emit event to notify parent of the update
