          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <div class="text-center mb-3">
                <img 
                  :src="currentUser.profilePhoto || '/default-pic.jpg'" 
...
export default {
  ...
  methods: {
    async updateUsername() {
      ...
      try {
        const response = await this.$axios.put(`/user/${this.currentUser.username}/setmyusername`, {
        ...
        this.errorMsg = error.response?.data || 'Failed to update username'
